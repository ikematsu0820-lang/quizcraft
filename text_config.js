...
const APP_TEXT = {
    ...
    Creator: {
        ...
        TypeSort: "並べ替え",
        TypeFreeOral: "1-2) 口頭で答える（口頭・司会判定）",
        TypeFreeWritten: "1-1) 手書きで答える（自由入力・司会判定）",
        TypeMulti: "多答クイズ",
        TypeAssoc: "連想クイズ",
        TypeMultiWritten: "4-1) 手書きで答える（自由入力・司会判定）",
        TypeMultiOral: "4-2) 口頭で答える（口頭・司会判定）",
        TypeRankingWritten: "4-3) ランキング・手書きで答える（自由入力・司会判定）",
        TypeRankingOral: "4-4) ランキング・口頭で答える（口頭・司会判定）",
        TypeAssocWritten: "5-1) 連想・手書きで答える（自由入力・司会判定）",
        TypeAssocOral: "5-2) 連想・口頭で答える（口頭・司会判定）",
        ...
        LabelTextFormat: "解答形式", TextFormatWritten: "手書きで答える", TextFormatOral: "口頭 (正解入力任意)", LabelSortInitial: "初期配置", SortInitialRandom: "ランダム (推奨)", SortInitialFixed: "固定 (作成順)",
